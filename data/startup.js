...
export const testimonials = [
  {
    ...
    color: '#6366f1',
    rating: 5,
    text: 'Rayix AI saved me hours every week. The prompt maker is insane — I went from struggling with Midjourney to generating stunning visuals in minutes.',
  },
  {
    name: 'Marcus Rivera',
  ...
  },
  {
    ...
    color: '#f59e0b',
    rating: 5,
    text: 'We use Rayix AI for our entire marketing team. The business prompt maker alone is worth 10x the price. Highly recommend the Team plan.',
  },
  {
    name: 'Alex Thompson',
    ...
    color: '#ef4444',
    rating: 5,
    text: 'The video prompt generator is perfect for Runway AI. My thumbnails and video scripts have never been better. Rayix AI is my daily driver.',
  },
  {
    name: 'Lena Müller',
    role: 'UX Designer',
  ...
  },
  {
    ...
    color: '#0891b2',
    rating: 5,
    text: 'We built our entire AI strategy around tools we discovered on Rayix AI. The directory is better than anything else out there. 10/10.',
  },
];
...
export const faqs = [
  {
    q: 'What is Rayix AI?',
    a: 'Rayix AI is the most comprehensive directory of AI tools online, combined with an AI Prompt Maker, free utilities, and tutorials — all in one place.',
  },
  {
